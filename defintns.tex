...
\newcommand{\Tiabl}{t_{i}^{\prime}}
% ablated time, component unspecified

\newcommand{\Tabl}[1]{t_{\mathrm{#1}^{\prime}}}
...
\newcommand{\griabl}{\lambda_{i}^{\prime}}
% growth rate, ablated, component unspecified

\newcommand{\grabl}[1]{\lambda_{\mathrm{#1}}^{\prime}}
