...
\graphicspath{{chapter_intro/}{chapter_methods/}}%{chapter4/}
...
Example citation for testing: \citet{papagiannakisAutonomousMetabolicOscillations2017}. 
