...
%\documentclass[11pt,crest,nopardent,nosans,fancychap,hyper]{edengths}
...
%% Title
\title{Single-cell time-series analysis of metabolic rhythms in yeast}
...
%\includeonly{chapter_model/chapter_model, appendix/appendx1}
%\includeonly{chapter_biology/chapter_biology}
%\includeonly{chapter_analysis/chapter_analysis}
%\includeonly{chapter_methods/chapter_methods, chapter_analysis/chapter_analysis, appendix/appendx_analysis}
...
\include{chapter_methods/chapter_methods}
\include{chapter_biology/chapter_biology}
\include{chapter_analysis/chapter_analysis}
\include{chapter_model/chapter_model}
...
\include{appendix/appendx_analysis}
\include{appendix/appendx_model}
