...
%  Furthermore, the molecular mechanism of the YMC is unclear.
  ...
  After considering the merits and caveats of such tools, I develop a method to filter time series, develop a machine learning model to classify whether time series are oscillatory, and develop a autocorrelation method to examine the periodicity of time series data.
