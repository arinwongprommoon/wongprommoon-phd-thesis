...
In budding yeast (\emph{Saccharomyces cerevisiae}), the cell division cycle is divided into the G\textsubscript{1}, S, G\textsubscript{2}, and M phases (figure~\ref{fig:intro-cdc-overview}).
