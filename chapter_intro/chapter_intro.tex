...
In other words, this thesis aims to reconcile conflicting findings about the yeast metabolic cycle from chemostat-based and single-cell studies.
The thesis does so by testing conclusions from chemostat-based studies using a microfluidics platform.
Such a platform eliminates communication between cells, while a chemostat does not.
In addition, based on the sequence of events in the yeast metabolic cycle reported in the literature, this thesis aims to show whether proteomic constraints explain the temporal segregation of biosynthetic events.
The thesis does so by employing flux balance analysis on an enzyme-constrained genome-scale metabolic model of budding yeast.
