...
Several deletions have been shown to remove the metabolic oscillations in chemostats: zwf1$\Delta$ \citep{tuCyclicChangesMetabolic2007}, gsy2$\Delta$, and gph1$\Delta$ \parencite{oneillEukaryoticCellBiology2020}.
...
\textcite{caustonMetabolicCyclesYeast2015} provide several examples, of which I discuss rim11$\Delta$, swe1$\Delta$, and tsa1$\Delta$ tsa2$\Delta$. % they actually had more, but these are the three that pop in my head right now
...
\citet{gudipatiFlavoproteomeYeastSaccharomyces2014} describe 68 genes that code for 47 flavoproteins in budding yeast (figure~\ref{fig:intro-flavoprotein-abundance}).
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{sbbs}
    ...
    \midrule
    fas1 & beta subunit of fatty acid synthetase & \ce{acetyl-CoA + malonyl-CoA + NADPH + ATP -> palmitate} & \citet{singhDiscoveryRegulatorySubunit2020} \\
    yhb1 & nitric oxide oxidoreductase & \ce{2NO + 2O2 + NAD(P)H -> 2NO3- + NAD(P)+ + H+} & \citet{bonamoreFlavohemoglobinStructureReactivity2008} \\
    ura1 & dihydroorotate dehydrogenase & \ce{dihydroorotic acid + fumarate -> orotic acid + succinate} & \citet{zameitatDihydroorotateDehydrogenaseSaccharomyces2007} \\
    pst2 & NAD(P)H-quinone oxidoreductase & \ce{NAD(P)H + H+ + quinone -> NAD(P)+ + hydroquinone} & \citet{kochStructureBiochemicalKinetic2017} \\
    trr1 & cytoplasmic thioredoxin reductase & \ce{H+ + NADPH + thioredoxin disulfide -> NADP+ + thioredoxin} & \citet{machadoThioredoxinReductasedependentInhibition1997} \\
    ilv2 & acetolactate synthase & \ce{2 pyruvate -> 2-acetolactate + CO2} & \citet{pangCrystalStructureYeast2002} \\
    oye2 & NADPH oxidoreductase & \ce{NADPH + H+ + acceptor <--> NADP+ + reduced acceptor} & \citet{odatOldYellowEnzymes2007} \\
    dld3 & 2-hydroxyglutarate transhydrogenase & \ce{D-2-hydroxyglutarate + pyruvate -> \alpha-ketoglutarate + lactate} & \citet{becker-ketternSaccharomycesCerevisiaeForms2016} \\
    pdx3 & pyridoxine phosphate oxidase & \ce{pyridoxamine 5-phosphate + H2O + O2 -> pyridoxal 5-phosphate + NH3 + H2O} & \citet{tsugePurificationPropertiesPyridoxamine1979} \\
    erg1 & squalene epoxidase & \ce{squalene + H+ + NADPH + O2 -> 2,3-oxidosqualene + NADP+ + H2O} & \citet{satohEnzymaticPropertiesSqualene1993} \\
    lpd1 & dihydrolipoamide dehydrogenase & \ce{dihydrolipoamide + NAD+ -> lipoamide + NADH+ + H+} & \citet{morrisonChapter14Dihydrolipoamide2021} \\
    \bottomrule \\
  \end{tabularx}
  \caption{
...
Flavins are linked to NAD(P)H via nitric oxide oxidoreductase (Yhb1p), as discussed in section \ref{subsubsec:intro-flavin-biochem-descriptions}, and NAD(P)H cycles have been implicated in bulk-culture \citep{tuLogicYeastMetabolic2005} % and more
