...
% Using unsupervised clustering, \citet{tuLogicYeastMetabolic2005} described the following events in each phase: --> WOULD LIKE TO AVOID THIS BECAUSE IT'S A REFERENCE TO JUST ONE PUBLICATION -- I'D RATHER WORK FROM THE CONSENSUS --> Zylstra & Heinemann 2022 and Mellor 2016 say something useful and perhaps discuss other evidence for the three phases.  Alternatively, I can say 'these three phases were initially found from this method...'
...
% This is a good place to add justification of these wavelengths; start from 'chain' of publications linked to the 2 main flavin-based YMC studies
