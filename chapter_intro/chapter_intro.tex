...
Focusing on the 12 most abundant abundant \citep{hoUnificationProteinAbundance2018} flavoproteins...
...
\begin{itemize}
\item Because budding yeast can uptake riboflavin via Mch5 (\cite{gudipatiFlavoproteomeYeastSaccharomyces2014a}), using nutrient media that contains riboflavin may confound flavin oscillations.  Specifically, we cannot tell apart intracellular flavin that derives from riboflavin uptake and from \emph{de novo} biosynthesis.
\begin{itemize}
