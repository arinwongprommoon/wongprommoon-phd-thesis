...
Metabolome cycling may play a role in the metabolic cycle and can explain temporal partitiong of biosynthesis, but the evidence so far is indirect as it is based on the cell division cycle.
\citet{campbellBuildingBlocksAre2020} show that there is cycling of lipid stores during the cell division cycle and the precursors are synthesised as they are needed, as evidenced by metabolome abundance data.
