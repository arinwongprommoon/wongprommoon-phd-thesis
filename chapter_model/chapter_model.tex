...
Fig.\ \ref{fig:model-grid-glc-ratio} shows two regions of interest: where $\ratioabl > 1$, in which parallel biosynthesis is advantageous, and where $\ratioabl < 1$, where sequential biosynthesis is advantageous.
Parallel biosynthesis is advantageous in in two circumstances: when both glucose and ammonium limit the growth rate, and when ammonium exchange is at saturation while glucose exchange is greater than saturation.
