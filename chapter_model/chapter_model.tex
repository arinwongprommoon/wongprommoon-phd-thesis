...
\begin{figure}
  ...
  \centering
    ...
    \caption{
      The gradients of growth rate with respect to horizontal (glucose exchange) and vertical (ammonium exchange) axes were computed.
  ...
  \caption{
    Effect of glucose and ammonium exchange rates in the ecYeast8 model on various quantities.
