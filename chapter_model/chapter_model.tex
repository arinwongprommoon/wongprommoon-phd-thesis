...
\begin{enumerate}
  ...
  \item This resource allocation strategy remains advantageous in many nutrient conditions and in deletion strains.
        The retention of the advantage explains the robustness of the yeast metabolic cycle.
...
Metabolic network reconstructions may include reactions that do not correspond to true, singular reactions in the strict chemical sense, in which one or more chemical species react then create a different set of chemical species as products.
...
The objective function is given as the task of minimising or maximising a mathematical expression that is based on a subset of fluxes.
...
In this chapter, I use a genome-scale model of \textit{Saccharomyces cerevisiae} and perform FBA.
...
\end{equation}
with the stoichiometric coefficient $n_{ij} = \frac{1}{k_{\mathrm{cat}}^{ij}}$.
