...
However, the ratio is not constant, but climbs up in steps (figure~\ref{fig:model-pool-ratio}).
With higher $\epool^{\prime}$ values --- that is, less of a constraint on the enzyme pool --- the ratio increases, indicating less advantage for sequential biosynthesis.
