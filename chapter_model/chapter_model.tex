...
\begin{figure}
  ...
  \caption{
    ...
    Each row represents an enzyme, and rows are grouped by subsystem.
    Colours represent $\log_{2}(\mathrm{FC})$ (Eq.\ \ref{eq:model-foldchange}) showing how enzyme usage fluxes (Eq.\ \ref{eq:model-gecko-enzyme-usage}) change in rounds of ablation: green shows an increase, while pink shows a decrease.
