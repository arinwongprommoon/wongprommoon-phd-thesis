...
% Writing idea: take intro/discussion (or what I have in my head as intro/discusion parts) of each section of this chapter and synthesise a story.  I'll probably be able to come up with something when my brain is less dead.
Can be seen as part of a long data analysis pipeline, to be used in the biological results chapter.
This can be an interesting software engineering question to bring it all together.

Intellectual investigation in its own right and opens more questions than answers.
Future direction e.g. using Bayesian method to classify oscillations, whether better data or better featurisation helps.

The running theme here: lots of judgement calls.
For example, threshold to tell apart oscillating and non-oscillating time series.
