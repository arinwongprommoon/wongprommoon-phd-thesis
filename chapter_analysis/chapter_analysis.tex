...
% TODO:
% - Erase titles of signal subplots, in favour of text in subfigure captions.
% - Change time points to minutes
% - Check window size of sliding-window -- it seems like it's using a window size of 80.
\begin{figure}
  \centering
