...
In this section, I represented each time series with a vector of features using \textit{catch22}.
...
Then, I pruned this complete graph to produce an incomplete graph by letting each node retain at least $k$ nearest neighbours, choosing $k = 5$ initially.
