...
I employed the \emph{hctsa} toolbox \parencite{fulcherHctsaComputationalFramework2017} to compute vectors of features for each time series.
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{bbS}
    ...
    \bottomrule \\
  \end{tabularx}
  \caption{\emph{catch22} features, adapted from \textcite{lubbaCatch22CAnonicalTimeseries2019}.
  }
  \label{tab:catch22}
\end{table}
