...
\begin{figure}
  ...
  \caption{
    ...
    Mean growth rate of parent cells, derived from estimated changes in volume (shading: 95\% confidence intervals) and
...
In addition, the lower cumulative number of budding events in the HTB2::mCherry strain, consistent across all experiments, may be explained by the increased phototoxicity generated by mCherry imaging in five z-slices (section~\ref{sec:methods-microfluidics}).
...
\begin{figure}
  ...
  \caption{
    Mean growth rate of parent cells, derived from estimated changes in volume (shading: 95\% confidence intervals) of FY4 (blue) and HTB2::mCherry (orange) strains over time, for \textbf{(\ref{fig:biology-lowglc-gr})} the glucose-limiting condition (\SI{0.010}{\gram~\litre^{-1}}) and \textbf{(\ref{fig:biology-highglc-gr})} the high glucose condition (\SI{20}{\gram~\litre^{-1}}).
