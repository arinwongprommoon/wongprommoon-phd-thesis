...
\begin{figure}
  \centering
    ...
    \caption{
      ...
      Figure shows sample flavin fluorescence (purple) and histone 2B (pink) level in a single cell grown in \SI{20}{\gram~\litre^{-1}} glucose.
...
\section{Do single-cell flavin traces recapitulate dissolved-oxygen YMCs in chemostats? -- potassium-deficient media}
