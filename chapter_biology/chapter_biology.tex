...
Though, the presence of metabolic cycles in atp5$\Delta$ and cyt1$\Delta$ mutants  \parencite{baumgartnerFlavinbasedMetabolicCycles2018} and in high-glucose conditions in this chapter support the assertion that respiration is not required for the metabolic cycle.
