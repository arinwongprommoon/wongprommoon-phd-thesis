...
\begin{figure}
  ...
  \begin{subfigure}[htpb]{0.4\textwidth}
   \centering
   \includegraphics[width=\textwidth]{median_aligned_edit.pdf}
   \caption{
  ...
  \begin{subfigure}[htpb]{0.4\textwidth}
   \centering
   \includegraphics[width=\textwidth]{fy4_26643_plots_10.png}
   \caption{
  ...
  \begin{subfigure}[htpb]{0.4\textwidth}
   \centering
   \includegraphics[width=\textwidth]{acf_and_histogram.pdf}
   \caption{
  ...
  \caption{
    The yeast metabolic cycle and cell division cycle synchronise within each cell in a population of cells (n = 400) under the same conditions (\SI{20}{\gram~\litre^{-1}} glucose).
...
\begin{figure}
  ...
  \begin{subfigure}[htpb]{0.7\textwidth}
   \centering
   \includegraphics[width=\textwidth]{fy4_19972_plots_butter_04.png}
   \caption{
     Heatmap shows the flavin fluorescence of each cell in a population over time.
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.4\textwidth}
   \centering
   \includegraphics[width=\textwidth]{pyruvate_acf_and_histogram.pdf}
   \caption{
...
\begin{figure}
  ...
  \begin{subfigure}[htpb]{0.7\textwidth}
   \centering
   \includegraphics[width=\textwidth]{htb2mCherry_613_plots_7.pdf}
   \caption{
    Heatmap shows the flavin fluorescence of each cell in a population over time.
   }
  ...
  \begin{subfigure}[htpb]{0.7\textwidth}
   \centering
   \includegraphics[width=\textwidth]{htb2mCherry_613_plots_12.pdf}
   \caption{
     Autocorrelation functions and periods determined by Fourier spectrum of flavin fluorescence and histone 2B levels.
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.4\textwidth}
   \centering
   \includegraphics[width=\textwidth]{zwf1_align_edit.pdf}
   \caption{
     Median flavin fluorescence signal across cells (n = 457).%; each data point is the median of flavin fluorescence at each time point relative to the first birth.
  ...
  \begin{subfigure}[t]{0.4\textwidth}
   \centering
   \includegraphics[width=\textwidth]{zwf1_acf_edit.pdf}
   \caption{
  ...
  \begin{subfigure}[t]{0.4\textwidth}
   \centering
   \includegraphics[width=\textwidth]{zwf1_snr_edit.pdf}
   \caption{
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.4\textwidth}
   \centering
   \includegraphics[width=\textwidth]{tsa1tsa2morgan_align_edit.pdf}
   \caption{
  ...
  \begin{subfigure}[t]{0.4\textwidth}
   \centering
   \includegraphics[width=\textwidth]{tsa1tsa2morgan_acf_edit.pdf}
   \caption{
  ...
  \begin{subfigure}[t]{0.4\textwidth}
   \centering
   \includegraphics[width=\textwidth]{tsa1tsa2morgan_snr_edit.pdf}
   \caption{
